<template>
    <div class="justify-between flex flex-col-reverse md:flex-row items-center overflow-hidden">
                ...
                <div>
                    ...
                    <div class="flex flex-row space-x-4">
                        ...
                        <select v-model="selectedRelation"
                            ...
                            <option v-for="(relation, index) in relations" :key="index" :value="relation.id">{{
                                relation.name }}
                            </option>
                        </select>
                    ...
                    <div v-show="contentOptionsShown" class="flex gap-4 items-center pt-3">
                        <ContentButton enctype="multipart/form-data" type="input" fileType="file"
                            acceptType="application/pdf" icon="fa-file-pdf" class="py-2 px-4 text-lg rounded-full"
                            @add="addContent" />
