<template>
  <div
    class="flex flex-col bg-white max-h-[700px] max-w-[900px] overflow-y-auto rounded-md p-5 gap-5"
    @click.stop
  >
    <label for="">Type de signalment</label>
    <input
      type="text"
      class="bg-gouv-gray-300 border-b-2 border-black w-full p-3 rounded-t-md"
      v-model="data.reportType.name"
    />
