		...
		<div class="flex flex-col w-full gap-2">
			...
			<div>
				<div class="flex flex-row items-center justify-start gap-2">
					<IconButtonComponentVue icon="far fa-heart" action="like" :context-id="resource.id" active="true" />
					<IconButtonComponentVue icon="far fa-comment" action="comment" :context-id="resource.id"
						active="true" />
					<IconButtonComponentVue icon="fas fa-retweet" action="retweet" :context-id="resource.id"
						active="true" />
				</div>
			</div>
		</div>
