<template>
    <div class="flex flex-col w-full px-2 gap-5">
            ...
            <div class="flex flex-col gap-5 justify-around md:flex-row">
                ...
                <div class="flex flex-col gap-1.5 md:justify-center">
                    <div>
                        ...
                        <p class="text-gray-600 text-xs"><i class="fa-solid fa-calendar"></i> A rejoint le {{ formatDate(user.created_at) }}</p>
                    </div>
        ...
        <div class="w-full flex">
            <div class="w-1/3 flex flex-col justify-center items-center hover:bg-slate-300 text-center text-blue-700  ">
